...
public class CourseTest {
	...
	public void runTests()
	{
		...
		Course course = new Course("Flying", new Professor("Madame Hooche"), Grades.O, 1994, expected);
		...
		System.out.println("GET PROFESSOR  " + testgetProfessor(course, new Professor("Madame Hooche")));
